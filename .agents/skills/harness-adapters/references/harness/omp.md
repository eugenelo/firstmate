...
The Pi supervision branch is out of scope for omp; every actionable wake is delivered to main, including posture-only quiet mode, which launches no away daemon (`../../../docs/supervision-protocols/omp.md`).
...
Remote OMP secondmates use the ordinary remote launch and relaunch paths; [`docs/remote-secondmates.md`](../../../../../docs/remote-secondmates.md) owns their setup, required Herdr placement, and real-host verification procedure.
