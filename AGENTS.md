...
- While `state/.afk` exists, the daemon owns supervision; do not arm a separate watcher.
  The daemon is never launched on Pi or omp, where the ordinary supervision session continues under the record.
